...
### System Overview
```
User Interface → Cloud Storage → Cloud Functions → AI Services → Analytics
     ↓              ↓              ↓              ↓         ↓
   Web App    →  4 Buckets   →   2 Functions  → Document → BigQuery
                                                    AI &
                                                Translation
                                                   APIs
```
...
├── cloud-functions/
│   ├── document-processor/
│   │   ├── main.py                 # Document processing logic
│   │   └── requirements.txt        # Python dependencies
│   └── translation-processor/
│       ├── main.py                 # Translation processing logic
│       └── requirements.txt        # Python dependencies
├── web-app/
...
**Built with ❤️ for DATS 5750 Project 2**
